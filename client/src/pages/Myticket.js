        ...
        <div class="container py-4">
          ...
          <article class="postcard dark blue">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://paytmblogcdn.paytm.com/wp-content/uploads/2022/08/Blog-Voter-ID-Documents_Cover-banner_Final-800x500.png"
                alt="Image Title"
              />
            </a>
...
..             You can enroll as a voter if you are an Indian citizen and your age is 18 yrs or above and also you are an ordinarily resident of the part/polling area of the constituency where you want to be enroll.
              ...
              <ul class="postcard__tagbox">
                <li class="tag__item play blue">
                  <a href="https://voterportal.eci.gov.in/">
                    <i class="fas fa-play mr-2"></i>View More...
                  </a>
                </li>
              </ul>
            </div>
          ...
          <article class="postcard dark red">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://images.hindustantimes.com/rf/image_size_640x362/HT/p2/2020/10/27/Pictures/_62214bf6-1821-11eb-aa26-a55aef2d66ca.JPG"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text">
              <h1 class="postcard__title red">
                <a href="#">Search Your Name in Voter List</a>
              </h1>
          ...
          <article class="postcard dark green">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREovRVu1QfVznOVerlgo6uHFtFqLJ9YAr8MIJ9XRN86onRivxlWJP5KDUMXhYjra01WnE&usqp=CAU"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text">
              <h1 class="postcard__title green">
                <a href="#">Electoral Roll PDF </a>
              </h1>
              <div class="postcard__subtitle small"></div>
              <div class="postcard__bar"></div>
              <div class="postcard__preview-txt">
              ...
              <ul class="postcard__tagbox">
                <li class="tag__item play green">
                  <a href="https://services.india.gov.in/service/service_url_redirect?id=MTcwOA==">
                    <i class="fas fa-play mr-2"></i>View More...
                  </a>
                </li>
              </ul>
          ...
          <article class="postcard dark yellow">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://www.iasgyan.in//ig-uploads/images//image00630.png"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text">
              <h1 class="postcard__title yellow">
                <a href="#">POSTAL BALLOT FACILITY: INCLUSIVE ELECTIONS</a>
              </h1>
              <div class="postcard__subtitle small"></div>
              <div class="postcard__bar"></div>
              <div class="postcard__preview-txt">
              ...
              <ul class="postcard__tagbox">
                <li class="tag__item play yellow">
                  <a href=" https://eci.gov.in/files/file/11133-postal-ballot-facilities-for-absentee-voters-of-essential-services-senior-citizens-of-more-than-80-years-and-marked-pwd-electors/  ">
                    <i class="fas fa-play mr-2"></i>View More...
                  </a>
                </li>
              </ul>
          ...
          <article class="postcard dark green">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://www.indiablooms.com/news_pic/2016/3-1459499388.jpg"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text">
              <h1 class="postcard__title green">
                <a href="#">Complaints and Grievances</a>
              </h1>
              <div class="postcard__subtitle small"></div>
              <div class="postcard__bar"></div>
              <div class="postcard__preview-txt">
              ...
              <ul class="postcard__tagbox">
                <li class="tag__item play green">
                  <a href=" https://eci.gov.in/contact-us/ngsp/national-grievance-services-portal-r3/ ">
                    <i class="fas fa-play mr-2"></i>View More...
                  </a>
                </li>
              </ul>
        ...
        <div class="container py-2">
          ...
          <article class="postcard light red">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://resize.indiatvnews.com/en/resize/newbucket/730_-/2019/04/gjh-1554797827-1554832091.jpg"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text t-dark">
              ...
              <ul class="postcard__tagbox">
                <li class="tag__item play red">
                  <a href="https://eci.gov.in/voter/voter-education/ ">
                    <i class="fas fa-play mr-2"></i>View More...
                  </a>
                </li>
              </ul>
          ...
          <article class="postcard light blue">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://eci.gov.in/uploads/monthly_2019_12/large.IMG_20191209_114727.jpg.8c31ea91164daa5937c9638630629631.jpg"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text t-dark">
              ...
              <ul class="postcard__tagbox">
                <li class="tag__item play blue">
                  <a href="https://eci.gov.in/screen-reader-access/ ">
                    <i class="fas fa-play mr-2"></i>View More...
                  </a>
                </li>
              </ul>
          ...
          <article class="postcard light red">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://img.freepik.com/free-vector/hand-with-voting-sign-election_1017-18637.jpg?w=360"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text t-dark">
...
The Observer Portal provides election observers with real-time access to information related to the electoral process. It enables observers to submit their reports, observations, and feedback through the portal. The portal also allows observers to upload photos and videos related to the electoral process.
              ...
              <ul class="postcard__tagbox">
                <li class="tag__item play red">
                  <a href="https://observerseci.eci.nic.in/ ">
                    <i class="fas fa-play mr-2"></i>View More...
                  </a>
                </li>
              </ul>
          ...
          <article class="postcard light green">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://hindi.eci.gov.in/uploads/monthly_2022_01/aff1.thumb.jpg.edbce04bc5924db9087a573777e294b1.jpg.a4941f2f5bb7eef6bafc707cfc7cf36e.jpg"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text t-dark">
...
The Candidate Affidavit Management System allows candidates to file their affidavits online, and the system verifies the information provided by them. The system also makes the affidavits available to the public, enabling citizens to view and access the information provided by the candidates.
          ...
          <article class="postcard light yellow">
            <a class="postcard__img_link" href="#">
              <img
                class="postcard__img"
                src="https://i.pinimg.com/280x280_RS/9a/d5/3a/9ad53a8d193efc67918554a730d6f6d2.jpg"
                alt="Image Title"
              />
            </a>
            <div class="postcard__text t-dark">
...
They include Press Releases,Audio and Visual Content,etc.
              ...
              <ul class="postcard__tagbox">
                <li class="tag__item play yellow">
                  <a href="https://eci.gov.in/media-publication/media-publication/ ">
                    <i class="fas fa-play mr-2"></i>View More...
                  </a>
                </li>
              </ul>
